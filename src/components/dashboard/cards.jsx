...
//           <div className="">
//             {/* Activate Card */}
//             {activeCard.card_status?.toLowerCase() === "pending activation" && (
//               <>
...
//             {/* Unblock Card */}
//             {activeCard.card_status?.toLowerCase() === "inactive" && (
//               <>
//                 <div className="card-action-container">
//                   <CustomButton
//                     label={"Unblock Card"}
...
//             {/* Set PIN */}
//             {activeCard.card_type?.toLowerCase() === "gpr_phy" && (
//               <div className="card-action-container">
...
//             {activeCard.card_status?.toLowerCase() === "active" && (
//               <div className="card-action-container">
...
//             {activeCard.card_status?.toLowerCase() !== "suspended" && (
//               <div className="card-action-container">
...
//   // Function to refresh cards data
...
//     // Enhanced handler for temporary block with toaster and refresh
...
//         toast.success("Card has been temporarily blocked successfully!", {
//           position: "top-right",
//           autoClose: 3000,
...
//     // Enhanced handler for unblock with toaster and refresh
...
//       } catch (error) {
//         // Show error toaster
//         toast.error("Failed to unblock card. Please try again.", {
//           position: "top-right",
//           autoClose: 3000,
//           hideProgressBar: false,
//           closeOnClick: true,
      ...
      try {
        await dispatch(
          temporaryBlockCardDetails({
            ...
            cardId: activeCard.card_hash_id,
            setCardLoading,
            handleCloseCardModalActions: () => {}, // Don't close immediately, handle manually
          })
        );
        ...
        // Close the card settings modal after successful operation
        handleCloseCardModalActions();
      } catch (error) {
        // Show error toaster
        toast.error("Failed to block card. Please try again.", {
