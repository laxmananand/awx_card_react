...
export const Sidebar = () => {
  ...
  return (
    <div
      className="d-flex flex-column flex-shrink-0 justify-content-between "
      style={{
        width: expanded ? 250 : 90,
        height: "100vh",
        backgroundColor: "rgb(153, 176, 193)",
    ...
    >
      <div>
        ...
        <div
          ...
          style={{ minHeight: 100 }}
        >
          {expanded && <img src="/logo_new.svg" alt="" width={85} />}
          <IconButton
            className=" text-white border border-secondary"
            style={{ backgroundColor: "rgb(153, 176, 193)" }}
            sx={{
              width: 30,
              height: 30,
              position: "absolute",
